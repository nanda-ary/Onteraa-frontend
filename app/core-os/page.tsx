...
import { FcDataProtection, FcGoogle, FcKey } from "react-icons/fc"
...
export default function LoginPage() {
      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground text-sm">
            Sign in to continue to Core Os
          </p>
        </div>
        ...
        <Button asChild variant="outline" className="w-full">
          <Link href="#">
            <FcDataProtection className="text-xl" />
            <span>Continue with Smart Key</span>
          </Link>
        </Button>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
  <label className="block mb-1 text-sm">Safe ID</label>
  <div className="flex items-center gap-2">
    <input
      ...
      placeholder="Enter your safe ID"
